...
async def _check_admin_status(message_or_cq, require_owner_only: bool) -> bool:
...
async def is_admin(message_or_cq) -> bool:
    return await _check_admin_status(message_or_cq, require_owner_only=False)

async def is_group_owner(message_or_cq) -> bool:
    return await _check_admin_status(message_or_cq, require_owner_only=True)
